...
function App() {
  ...
  useEffect(() => {
    ...
    let finalAmount = sumAantal + (sumAantal * btw[land] ) - (sumAantal * korting)
  ...
  return (
    <div className="relative min-h-screen w-screen flex flex-col items-center justify-center bg-gradient-to-br from-orange-100 via-white to-orange-200 overflow-hidden">
